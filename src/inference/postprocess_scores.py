...
def main():
    in_path = PROJECT_ROOT / "outputs" / "churn_scores_timesplit.csv"
    ...
    # With buckets
    with_buckets = out_dir / "churn_scores_timesplit_with_buckets.csv"
    ...
    # Top 5000
    top5000 = out_dir / "churn_scores_timesplit_top5000.csv"
    scores_sorted.head(5000).to_csv(top5000, index=False)

    # Split by bucket
    critical = out_dir / "churn_scores_timesplit_critical.csv"
    high = out_dir / "churn_scores_timesplit_high.csv"
